...
<section class="container">
        ...
        <ul class="nav">
            ...
            <c:forEach items="${categoryList}" var="category">
                <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-61">
                    <%--展示指定类别的所有文章,通过Controller处理loadPage后到home/articlepager1.jsp--%>
    ...
    <div class="content-wrap">
        <%--中间的内容   不是for循环
            home/index.jsp提交以后通过js到了article/article_list.js,然后又跳转到HomeController层的lodPageAll--%>
...
<%--从本项目的指定路径获取js文件--%>
<%--<script>内部的代码没有位于某个函数中，那么这些代码会在 页面被加载时被立即执行 --%>
